 ...
 * @author ASUS
 */
public class Border_Layout extends javax.swing.JFrame {

    /**
     * Creates new form Border_Layout
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Border_Layout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Border_Layout().setVisible(true);
            }
        });
    }
